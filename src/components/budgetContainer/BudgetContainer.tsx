...
export function BudgetContainer() {
    ...
    return (
        <div className="flex w-full justify-center items-center min-h-screen bg-gray-700">
            <div className="w-full flex flex-col justify-center items-center place-content-between
            bg-gray-700">
