    ...
    max-h-full">
        ...
        shadow-sm dark:bg-gray-700">
            ...
            <div className="p-4 md:p-5 text-center">
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">${props.customText}</h3>
                <p>{`The cost per ${props.customDescription} is an extra ${props.customPrice}`}</p>
            </div>
        </div>
    </div>
</div>
